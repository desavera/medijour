...
public class PhotoiSQLiteManager extends SQLiteOpenHelper {
    ...
    public static final String JOURNALS_DATA_COLUMN = "JOURNALSdata";
    ...
    private static final String JOURNALS_CREATE = "create table " + JOURNALS_TABLE + " (_id integer primary key autoincrement, JOURNALSdata text not null);";
    private static final String PAYMENT_REQUEST_CREATE = "create table " + PAYMENT_REQUEST_TABLE + "  (_id integer primary key autoincrement, user_id integer,JOURNALS_id integer,foreign key(user_id) references users(_id),foreign key(JOURNALS_id) references JOURNALS(_id));";
