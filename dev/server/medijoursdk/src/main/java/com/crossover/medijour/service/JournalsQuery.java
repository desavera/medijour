...
public class JournalsQuery {

	
	// the default date format
	public final static SimpleDateFormat SDF = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
	
	final static Logger logger = Logger.getLogger(JournalsQuery.class); 
	...
	public JournalsQuery(String origin, String destiny, String departuring, String returning,
			int npassengers) {
